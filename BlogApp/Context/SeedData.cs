			...
			if (context != null)
			{
				...
				if (!context.Users.Any())
				{
					context.Users.AddRange(
						new User { UserName = "hdr",Name="Hıdır Çelikel",Email="info@hdrcelikel.com",Password="123456" ,Image ="p1.jpg" },

							new User { UserName = "rba", Name = "Rabia Çelikel", Email = "info@rbacelikel.com", Password = "12345", Image = "p2.jpg" }
					);
					context.SaveChanges();
				}
